...
public class MutualFollowersApp implements CommandLineRunner {
    ...
    private static final String NAME = "MODILI DEEPAK";
    private static final String REG_NO = "RA2211027010259";
    private static final String EMAIL = "dm9547@srmist.edu.in";
    ...
    public void run(String... args) throws Exception {
        ...
        if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
            ...
            if (dataObj instanceof Map) {
                ...
                Object usersWrapperObj = data.get("users");

                if (usersWrapperObj instanceof Map) {
                    Map<String, Object> usersWrapper = (Map<String, Object>) usersWrapperObj;
                    Object usersObj = usersWrapper.get("users");
                    ...
                    if (usersObj instanceof List) {
                        ...
                        // 🖨️ Print final answer before sending
                        System.out.println("📤 Final Answer Sent:");
                        System.out.println(finalAnswer);

                        sendWithRetry(webhook, accessToken, finalAnswer, 4);
                    } else {
                        System.out.println("❌ 'users.users' is not a List.");
                    }
                } else {
                    System.out.println("❌ 'users' is not a Map.");
                }
            } else {
